    ...
    <table>
      ...
      <tbody>
          ...
          <tr v-for="user in users" :key="user.id">
              ...
              <td>{{ user.email }}</td>
              <td>
                <Link class="btn btn-info" :href="`/user/edit/${user.id}`">Editar</Link>
                <Link class="btn btn-danger" :href="`/user/delete/${user.id}`"
                  method="delete" as="button" type="button">Excluir</Link>
              </td>
          </tr>
