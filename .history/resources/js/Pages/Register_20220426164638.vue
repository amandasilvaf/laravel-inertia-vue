    ...
    <table>
      ...
      <tbody>
          ...
          <tr v-for="(user, index) in users" :key="index">
              ...
              <td>{{ user.email }}</td>
              <td>
                <button type="text" class="btn btn-info" @click.prevent="editUser(user.id)">Editar</button>
                <a href="" role="button" class="btn btn-danger">Excluir</a>
              </td>
          </tr>
